...
- 题型板块：选择题、填空题、大题
- 选择题交互作答：A-D 按钮选择，能识别答案时自动标记会做/做错
- 题库表格
- 错题 / 待复习队列
...
- 基础统计
- 题目 / 解析 / 我的记录页签
- 题内自带 `【答案】/【解析】/解：` 时，题目页自动隐藏解析，解析页自动显示题内解析
...
- 题目和解析图片使用仓库内 `assets\` 相对路径，适合 GitHub Pages。
- 找源文件功能已移除，手机网页中不再尝试打开本机 E 盘路径。
- 解析文件格式不统一，当前题目级映射 893 条解析；未匹配但题内有解析的题目会在解析页显示题内解析。
...
- 桌面题型板块截图位置：`docs\desktop-type-board.png`
